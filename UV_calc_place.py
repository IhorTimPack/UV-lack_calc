...
3. В поля "Ширина" и "Длина" ввести размеры печатного листа в миллиметрах или нажать на соответствующую кнопку для выбора одного из типовых размеров;
4. В раскрывающемся списке выбрать один из предложенных вариантов лака. По умолчанию выбран "УФ-лак";
5. В раскрывающемся списке выбрать один из вариантов типа клиента. По умолчанию выбран тип "Премиум";
...
6. Убедиться, что выбран правильный текущему расчёту профиль. По умолчанию выбран профиль "Основной". Для ихменения профиля войдите в "Меню - Расценки" и выберите один из существующих профилей;
7. Для проведения расчета нажмите кнопку "Рассчитать".
В средней части экрана появятся результаты расчета в соответствующих полях. Если есть необходимост увидеть подробную калькуляцию расчёта, нажмите 
кнопку "Показать детали". Повторное нажатие на эту кнопку приведёт к удалению этой информации с рабочего экрана.
В правой части экрана появяться два графика, на которых можно увидеть влияние размера тиража на стоимость лакировки в цифрак стоимости тиража и 
стоимости лакировки одного листа. 
"""
