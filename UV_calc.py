...
report_type_client_name = Label(frame_3, text="Тип клиента:", justify=LEFT)
report_type_client_var = StringVar()
report_type_client = Label(frame_3, textvariable=report_type_client_var, font=16)
report_type_client_measure = Label(frame_3)
report_type_lack_name = Label(frame_3, text="Тип лака:")
report_type_lack_var = StringVar()
report_type_lack = Label(frame_3, textvariable=report_type_lack_var, font=16)
report_film_name = Label(frame_3, text="Плёнка:")
report_film_var = StringVar()
report_film = Label(frame_3, textvariable=report_film_var, font=16)
report_amount_name = Label(frame_3, text="Тираж:")
report_amount_var = StringVar()
report_amount = Label(frame_3, textvariable=report_amount_var, font=16)
report_amount_measure = Label(frame_3, text="лист.")
report_width_name = Label(frame_3, text="Ширина листа:")
report_width_var = StringVar()
report_width = Label(frame_3, textvariable=report_width_var, font=16)
report_width_measure = Label(frame_3, text="мм.")
report_length_name = Label(frame_3, text="Длина листа:")
report_length_var = StringVar()
report_length = Label(frame_3, textvariable=report_length_var, font=16)
report_length_measure = Label(frame_3, text="мм.")
report_percents_name = Label(frame_3, text="Процент заполнения листа:")
report_percents_var = StringVar()
report_percents = Label(frame_3, textvariable=report_percents_var, font=16)
report_percents_measure = Label(frame_3, text="%")
report_cost_all_amount_name = Label(frame_3, text="Стоимость лакировки тиража:")
report_cost_all_amount_var = StringVar()
report_cost_all_amount = Label(frame_3, textvariable=report_cost_all_amount_var, font=16, fg="red")
report_cost_all_amount_measure = Label(frame_3, text="грн.")
report_cost_one_sheet_name = Label(frame_3, text="Стоимость лакировки одного листа:")
report_cost_one_sheet_var = StringVar()
report_cost_one_sheet = Label(frame_3, textvariable=report_cost_one_sheet_var, font=16, fg="red")
report_cost_one_sheet_measure = Label(frame_3, text="грн.")
report_Kostil = Label(frame_3, width=26)
...
button_calculate = Button(frame_3, text="Рассчитать", command=calculate, width=60)
